...
import Pizza from "../../images/Pizza/Pizzaimg.jpg";
import Salad from "../../images/Salad/Saladimg.jpeg";
import Delivery from "../../images/Delivery/Fooddelivery1.jpg";
                ...
                <Container>
                    <Row>
                        <Col lg={{ span: 8, offset: 2 }} className="text-center">
                            <h2 className="text-white">The burger tastes better when you eat it with your family</h2>
